...
=pod`;
    ...
    test("document with ordinary paragaph", () => {
        const fileContents = `\
=pod
...
`;
    ...
    test("document with verbatim paragaph", () => {
        const fileContents = `\
=pod
...
... and also preceed in order, without skipping a number.
...
3. ... and also preceed in order, without skipping a number.
